...
const getSettings = context => {
  ...
  const settings = {
    ...
    maxLines: Number((_context$settings$jsd2 = (_context$settings$jsd3 = context.settings.jsdoc) === null || _context$settings$jsd3 === void 0 ? void 0 : _context$settings$jsd3.maxLines) !== null && _context$settings$jsd2 !== void 0 ? _context$settings$jsd2 : 1),
    minLines: Number((_context$settings$jsd4 = (_context$settings$jsd5 = context.settings.jsdoc) === null || _context$settings$jsd5 === void 0 ? void 0 : _context$settings$jsd5.minLines) !== null && _context$settings$jsd4 !== void 0 ? _context$settings$jsd4 : 0),
    // `check-tag-names` and many returns/param rules
    tagNamePreference: (_context$settings$jsd6 = (_context$settings$jsd7 = context.settings.jsdoc) === null || _context$settings$jsd7 === void 0 ? void 0 : _context$settings$jsd7.tagNamePreference) !== null && _context$settings$jsd6 !== void 0 ? _context$settings$jsd6 : {},
    // `check-types` and `no-undefined-types`
    preferredTypes: (_context$settings$jsd8 = (_context$settings$jsd9 = context.settings.jsdoc) === null || _context$settings$jsd9 === void 0 ? void 0 : _context$settings$jsd9.preferredTypes) !== null && _context$settings$jsd8 !== void 0 ? _context$settings$jsd8 : {},
    // `check-types`, `no-undefined-types`, `valid-types`
    structuredTags: (_context$settings$jsd10 = (_context$settings$jsd11 = context.settings.jsdoc) === null || _context$settings$jsd11 === void 0 ? void 0 : _context$settings$jsd11.structuredTags) !== null && _context$settings$jsd10 !== void 0 ? _context$settings$jsd10 : {},
    // `require-param`, `require-description`, `require-example`, `require-returns`
    overrideReplacesDocs: (_context$settings$jsd12 = context.settings.jsdoc) === null || _context$settings$jsd12 === void 0 ? void 0 : _context$settings$jsd12.overrideReplacesDocs,
    implementsReplacesDocs: (_context$settings$jsd13 = context.settings.jsdoc) === null || _context$settings$jsd13 === void 0 ? void 0 : _context$settings$jsd13.implementsReplacesDocs,
    augmentsExtendsReplacesDocs: (_context$settings$jsd14 = context.settings.jsdoc) === null || _context$settings$jsd14 === void 0 ? void 0 : _context$settings$jsd14.augmentsExtendsReplacesDocs,
    // Many rules, e.g., `check-tag-names`
    mode: (_context$settings$jsd15 = (_context$settings$jsd16 = context.settings.jsdoc) === null || _context$settings$jsd16 === void 0 ? void 0 : _context$settings$jsd16.mode) !== null && _context$settings$jsd15 !== void 0 ? _context$settings$jsd15 : context.parserPath.includes('@typescript-eslint') ? 'typescript' : 'jsdoc'
  };
