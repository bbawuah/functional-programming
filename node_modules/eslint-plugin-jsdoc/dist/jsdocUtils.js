...
const getPreferredTagName = (context, mode, name, tagPreference = {}) => {
  ...
  const tagPreferenceFixed = _lodash.default.mapKeys(tagPreference, (value, key) => {
...
const tagsWithNamesAndDescriptions = new Set(['param', 'arg', 'argument', 'property', 'prop', // These two are parsed by our custom parser as though having a `name`
'returns', 'return']);
